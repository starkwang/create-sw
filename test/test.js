...
var fs = require('fs');
var generate = require('../lib/create-sw.js').generate;
var generateRuntimeCaching = require('../lib/create-sw.js').generateRuntimeCaching;
var path = require('path');
var write = require('../lib/create-sw.js').write;
